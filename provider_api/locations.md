...
| `suitable_for_kinds`                  | String array                          | `suitable for kind` of location ("store": "cafe", "showroom", "clinic", "education", "popup_store", "office": "showroom", "clinic", "education", "business_center": "clinic", "education", "warehouse": "high_ceiling_storage", "storage_hotel", "production", "workshop"). "cafe" allowed only if main `kind` is "store", and so on. | Optional
