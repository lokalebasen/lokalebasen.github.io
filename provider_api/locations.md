...
| `suitable_for_kinds`                  | String array                          | `suitable for kind` of location (available suitable for kind by location's kind: `store`: "cafe", "showroom", "clinic", "education", "popup_store", `office`: "showroom", "clinic", "education", `business_center`: "clinic", "education", `warehouse`: "high_ceiling_storage", "storage_hotel", "production", "workshop"). | Optional
