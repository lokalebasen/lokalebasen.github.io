...
| `secondary_kinds`                     | String array                          | Secondary location `kind` ("office", "business_center", "warehouse", "store", "coworking", "meeting_room", "cafe"). "cafe" allowed only if main `kind` is "store" | Optional
